...
3. Unzip the ZIP file and rename the folder inside "cosmospay-woocommerce-main" to "cosmospay".

4. Zip the file again, the name of the ZIP file itself is not important.
